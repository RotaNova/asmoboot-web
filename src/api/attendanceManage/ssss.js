...
export default {
    ...
    getAccessFaceGroup: params => Axios.get(`/attendance/v1/attendanceDeviceManager/getAccessFaceGroup`, { params }),  // 获取通行权限人员分组
    getAccessFaceListPageList: params => Axios.post(`/attendance/v1/attendanceDeviceManager/getAccessFaceListPageList`, params),  // 获取通行权限人员分组
    chooseOrCancelAccessFaceList: params => Axios.post(`/attendance/v1/attendanceDeviceManager/chooseOrCancelAccessFaceList`, params),  // 通行权限勾选或取消勾选人员
