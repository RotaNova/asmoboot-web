...
import API from '@/api/IntelligentSecurity/blacklistRecord'
...
export default {
    data() {
        return {
            tableData: [],
            columns,
            searchCode: 'blacklist_list_search',
            ipagination: {
                current: 1,
                pageSize: 10,
    ...
    methods: {
        ...
        openDetails(row) {
            ...
            this.$store.commit('SET_INTELL_CALENDARURL', '/protection/v1/blacklist/getRecordInfo')
            this.$store.commit('SET_INTELL_EXPORTURL', '/protection/v1/blacklist/exportExcel')
            this.$store.commit(
                'SET_INTELL_COLORURL',
                '/protection/v1/blacklist/getTimeColorSetting'
            )
            this.$store.commit('SET_INTELL_ADDCOLORURL', '/protection/v1/blacklist/addTimeColor')
            this.$store.commit(
                'SET_INTELL_TABLIST',
                '/protection/v1/blacklist/listPersonalPassRecord'
            )
            let obj = {
                sysCaptureRecordId: row.sysCaptureRecordId
            }
            let url = '/protection/v1/blacklist/getRecordDetails'
