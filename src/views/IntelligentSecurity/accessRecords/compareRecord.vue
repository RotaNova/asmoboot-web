...
<script>
import API from '@/api/IntelligentSecurity/compareRecord'
...
export default {
    data() {
        return {
            tableData: [],
            columns,
            searchCode: 'comparison_list_search',
            ipagination: {
                current: 1,
                pageSize: 10,
    ...
    methods: {
        ...
        openDetails(row) {
            ...
            this.$store.commit('SET_INTELL_CALENDARURL', '/protection/v1/comparison/getRecordInfo')
            this.$store.commit('SET_INTELL_EXPORTURL', '/protection/v1/comparison/exportExcel')
            this.$store.commit(
                'SET_INTELL_COLORURL',
                '/protection/v1/comparison/getTimeColorSetting'
            )
            this.$store.commit('SET_INTELL_ADDCOLORURL', '/protection/v1/comparison/addTimeColor')
            this.$store.commit(
                'SET_INTELL_TABLIST',
                '/protection/v1/comparison/listPersonalPassRecord'
            )
            let obj = {
                sysCaptureRecordId: row.sysCaptureRecordId
            }
            let url = '/protection/v1/comparison/getRecordDetails'
