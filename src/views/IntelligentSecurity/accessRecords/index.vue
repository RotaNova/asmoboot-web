                    ...
                    >
                        ...
                        <span slot="operate" slot-scope="text, record">
                            ...
                            <span class="Authorized-users cursor" @click="compileData(record)"
                                >视频</span
                            >
                            <span class="segmentation" v-if="record.faceBaseMapUrl">|</span>
                            <span
                                class="Authorized-users cursor"
                                @click="openDetails(record)"
                                v-if="record.faceBaseMapUrl"
                                >详情</span
                            >
                        </span>
                    </a-table>
...
export default {
    ...
    methods: {
        ...
        openDetails(row) {
            ...
            this.$store.commit('SET_INTELL_CALENDARURL', '/protection/v1/pass/getRecordInfo')
            this.$store.commit('SET_INTELL_EXPORTURL', '/protection/v1/pass/exportExcel')
            this.$store.commit('SET_INTELL_COLORURL', '/protection/v1/pass/getTimeColorSetting')
            this.$store.commit('SET_INTELL_ADDCOLORURL', '/protection/v1/pass/addTimeColor')
            this.$store.commit('SET_INTELL_TABLIST', '/protection/v1/pass/listPersonalPassRecord')
            let obj = {
                sysCaptureRecordId: row.sysCaptureRecordId
            }
