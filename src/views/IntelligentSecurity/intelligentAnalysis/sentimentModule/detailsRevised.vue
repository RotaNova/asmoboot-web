...
<script>
import API from '@/api/IntelligentSecurity/sentimentDetection'
...
export default {
    ...
    methods: {
        ...
        closePeople(id) {
            ...
            API.deleteAbnormalPerson(parame).then((res) => {
        ...
        abnormalBehavior() {
            ...
            API.getAbnormalBehavior(parame)
                .then((res) => {
