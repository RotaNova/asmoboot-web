            ...
            <div>
                ...
                >
                    ...
                    <a-form-item
                        ...
                        style="text-align: center;margin-left: 99px;"
                    >
...
export default {
    ...
    data() {
        return {
            ...
            searchCode: 'sys_user_sys_search_sys',
            annlist: {},
            editor: null,
            editorContent: ''
        }
            ...
            this.form.validateFields((err, values) => {
                if (!err) {
                    ...
                    if (values.annTarget == 1) {
                        ...
                        parame.sysDeptIdList = []
                        this.DepartData.forEach((item) => {
                            parame.sysDeptIdList.push(item.value)
                        })
                    }
                    if (this.rowobj.sysAnnoId) {
