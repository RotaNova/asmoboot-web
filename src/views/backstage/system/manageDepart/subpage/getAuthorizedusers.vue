<template>
    <section>
        ...
        <addAuthorizedusers ref="authusers" @adchaner="getListDeptRoleUserList" />
    </section>
</template>
<script>
import API from '@/api/system/manageDepart/index'
import addAuthorizedusers from './adddepsption'
...
export default {
    ...
    data() {
        return {
            ...
            datalist: [],
            searchCode: 'dept_role_user_search'
        }
    },

    mounted() {
        this.getListDeptRoleUserList()
    },
    methods: {
        addueserdata() {
        ...
        getListDeptRoleUserList() {
            ...
            API.getListDeptRoleUserList(parame)
                .then((res) => {
