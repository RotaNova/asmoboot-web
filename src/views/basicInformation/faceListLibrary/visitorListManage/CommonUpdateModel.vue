    ...
    methods: {
        ...
        onChangeSearch: _debounce(function (value) {
            if (this.selectedKeysPeople) {
                ...
                API.getFaceListByGroupPageListVis(parame)
                    .then((res) => {
        ...
        relationFaceList(params) {
            ...
            API.relationFaceListVis(params)
                .then(() => {
        ...
        getRelationFaceList(params) {
            API.getRelationFaceListVis(params)
                .then((res) => {
                    // setTimeout(() => {
        ...
        cancelRelationFaceList(item) {
            ...
            API.cancelRelationFaceListVis(params)
                .then(() => {
