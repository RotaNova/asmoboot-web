<!--
 * @Descripttion:基础资料---人脸名单库---访客管理
 * @version: 1.0.0
 * @Author: LSC
 * @Date: 2021-08-20 14:37:24
 * @LastEditors: LSC
 * @LastEditTime: 2021-10-22 13:51:39
-->
<template>
    <section class="roleManage">
        ...
        />
        <!-- <add-import ref="addImport">
            <template #desc>
                <div class="mt16">2.请严格按照模板填写信息后再上传模板</div>
                <div class="mt16">3.建议单次上次名单数小于1000，最高不得超过3000人。</div>
                <div class="mt16">4.请严格按照模板填写信息后再上传模板</div>
            </template>
            <template #button>
                <a-button class="ml20" @click="handleCancels">关 闭</a-button>
                <a-button type="primary" class="ml20" @click="uploadFile"> 上 传 </a-button>
            </template>
        </add-import> -->
    </section>
</template>
...
export default {
    ...
    data() {
        return {
            TYPE_PEOPLE_LIST_VIS: 3, //3 表示访客
            title: '',
            searchCode: 'faceListVistorSearch',
            isSpinning: true,
            loading: true,
    ...
    methods: {
        ...
        // *获取所有访客人员 /basedata/v1/whileFaceListManage/getFaceListItemPageList
        getFaceListItemPageList(obj) {
            ...
            API.getFaceListItemPageListVis(params)
                .then((res) => {
