 ...
 * @LastEditors: LSC
 * @LastEditTime: 2021-10-12 14:47:57
-->
<template>
    <section>
        <a-modal
...
import commonUpdateMixins from '../mixins/commonUpdateMixins'
    ...
    methods: {
        ...
        onChangeSearch: _debounce(function (value) {
            if (this.selectedKeysPeople) {
                ...
                API.getFaceListByGroupPageList(parame)
                    .then((res) => {
        ...
        getRelationFaceList(params) {
            API.getRelationFaceList(params)
                .then((res) => {
                    // setTimeout(() => {
        ...
        cancelRelationFaceList(item) {
            ...
            API.cancelRelationFaceList(params)
                .then(() => {
